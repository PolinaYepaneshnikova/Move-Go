  ...
  return (
    <header className="appUpHeader">
      ...
      <div className='appUpHeader__menu'>
        ...
        <NavLink to={`/profile/${data?.userName}`} className='appUpHeader__menu-link'><img src={data?.avatar ?? noAvatar} alt="photo_user" className='appUpHeader__menu-photo' /></NavLink>
